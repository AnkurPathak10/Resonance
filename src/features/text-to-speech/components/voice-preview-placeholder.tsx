  ...
  return (
    <div className="hidden flex-1 lg:flex h-full flex-col items-center justify-center gap-6 border-t">
      <div className="flex flex-col items-center gap-3">
        <div className="relative flex min-w-32 shrink-0 items-center justify-center">
          <div className="absolute top-1/2 left-0 z-0 -translate-y-1/2 rotate-[-30deg] rounded-full bg-muted p-4">
          ...
          <div className="absolute top-1/2 right-0 z-0 -translate-y-1/2 rotate-[-30deg] rounded-full bg-muted p-4">
      ...
      <Button variant="outline" size="sm" asChild>
        <Link href="mailto:ankur.business10@gmail.com">
          <BookOpen />
          Don&apos;t know how?
        </Link>
      </Button>
